...
# --- Sidebar / model picker (keep your existing code) ---
...
if run_btn:
    try:
        ...
        if resume_file is not None:
            # Uploaded file path: handle PDF vs text
        ...
        # Trim and fill prompt
        posting_trimmed = soft_trim(posting_text, max_chars=12000)  # adjust if you have a constant
        ...
        with st.spinner('Calling model...'):
            result = run_llm(system_prompt, user_prompt, model='gpt-4o-mini')
